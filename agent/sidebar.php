...
if (!isset($_SESSION["agent_name"])) {
    // Agent not logged in, redirect to the login page
                ...
                <div class="header-menu">
                    <div class="header-left">
                        <div style="position: relative; top: 50%; transform: translateY(-50%);">
                            <p>Welcome <?php echo $agentName; ?> </p>
                        </div>
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <?php
                            // Fetch the avatar image from the database
                            $select_query = "SELECT image FROM tbl_agent WHERE name = '" . $_SESSION['agent_name'] . "'";
                            $execute_select = mysqli_query($connect, $select_query);
                            $row = mysqli_fetch_assoc($execute_select);

                            if (!empty($row['image'])) {
                                echo '<img class="user-avatar rounded-circle" src="uploads/' . $row['image'] . '" alt="">';
                            }
                            ?>
                        </a>
