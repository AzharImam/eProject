                    ...
                    <div class="card">
                        ...
                        <div class="row">
                            <div class="card-body">
                                ...
                                <div class="container">
                                    <a href="service_Create.php" class="btn btn-success mb-3">Add New</a>
                                    ...
                                    <table class="table table-hover text-center">
                                        ...
                                        <tbody>
                                            <?php
                                            $select_query = "SELECT * FROM `tbl_service`";
                                            ...
                                            ?>
                                                    <tr id="<?php echo $row["id"] ?>">
                                                        ...
                                                        <td>
                                                            <a href="service_Update.php?id=<?php echo $row["id"] ?>" class="link-dark"><i class="fa fa-refresh fs-5 me-3" style="color: green"></i></a>
            ...
            if (confirm('Are you sure you want to remove this record ?')) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        // window.location.href = "service_Read.php";
